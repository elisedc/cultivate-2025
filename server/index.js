...
const links = () => [{
  ...
  rel: "stylesheet",
  href: "https://fonts.googleapis.com/css2?family=UoqMunThenKhung&display=swap"
}];
function Layout({
  children
}) {
...
function Welcome() {
  return /* @__PURE__ */ jsxs("main", { className: "relative w-screen h-screen overflow-hidden", children: [
    ...
    /* @__PURE__ */ jsx("img", { src: sunImage, alt: "Sun", className: "absolute w-full h-full object-cover animate-sunrise" }),
    /* @__PURE__ */ jsx("img", { src: fieldsImage, alt: "Fields", className: "absolute w-full h-full object-cover animate-fields-brighten" }),
    /* @__PURE__ */ jsx("img", { src: notesImage, alt: "Notes", className: "absolute w-full h-full right-0 object-cover object-right animate-notes-sweep" }),
    /* @__PURE__ */ jsxs("div", { className: "absolute top-1/2 md:left-12 transform -translate-y-12 flex flex-col items-center md:items-start gap-4 not-md:w-screen", children: [
      /* @__PURE__ */ jsx("h1", { className: "text-7xl md:text-9xl text-center text-on-primary opacity-0 animate-fade-up", children: "耕耘季" }),
      /* @__PURE__ */ jsx(
        "button",
        {
...
function meta({}) {
  return [{
    ...
    name: "description",
    content: "Welcome to Cultivate 2025!"
  }];
}
